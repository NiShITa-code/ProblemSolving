...
class Solution
{
    ...
    void reversePreOrder(Node* node, int level) {
        ...
        if (level == rightViewAns.size()) {
            rightViewAns.push_back(node -> data);
        }
    ...
    vector<int> rightView(Node *root)
    {
       ...
       // we can implement tit using level order traversal as well as a recursive solution
       // we choose recusrsive solution because here it will be space optimised
